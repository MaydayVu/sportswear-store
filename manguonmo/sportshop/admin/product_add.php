...
if (isset($_POST["submit"])) {
    ...
    try {
        $name       = $conn->real_escape_string($_POST["ten"]);
        $brand      = $conn->real_escape_string($_POST["thuonghieu"]);
        $category   = (int)$_POST["phanloai"];
        $price      = (float)$_POST["gia"];
        $gender     = $conn->real_escape_string($_POST["gioitinh"]);
        $sport_type = $conn->real_escape_string($_POST["thethao"]);
        $discount   = (int)$_POST["giamgia"];
        $desc       = $conn->real_escape_string($_POST["mota"]);
        $material   = $conn->real_escape_string($_POST["chatlieu"]);
        ...
        $sql = "INSERT INTO products 
                (name, brand, category_id, gender, sport_type, price, discount_percent, description, material, featured, image) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($sql);
        if (!$stmt) {
            throw new Exception("Lỗi prepare products: " . $conn->error);
        }
        ...
        if (!$stmt->execute()) {
            throw new Exception("Lỗi execute products: " . $stmt->error);
        }
        ...
        if (isset($_POST["sizes"]) && is_array($_POST["sizes"])) {
            ...
            foreach ($_POST["sizes"] as $size_data) {
                ...
                $size_stmt->bind_param("isi", $product_id, $size_name, $size_quantity);
...
<head>
    ...
    <title>Thêm Sản Phẩm - Admin Sport Fashion</title>
...
<body>
            ...
            <form method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="ten" required placeholder="Nhập tên sản phẩm">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Thương hiệu <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="thuonghieu" required placeholder="Nhập thương hiệu">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="thethao">
                                ...
                                <option value="court_sports">Thể thao trên sân</option>
                            </select>
                            <div class="mt-2">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="gia" min="0" step="1000" required placeholder="0">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giảm giá (%)</label>
                            <input type="number" class="form-control" name="giamgia" min="0" max="100" value="0" placeholder="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="mota" rows="4" placeholder="Mô tả chi tiết về sản phẩm..."></textarea>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Chất liệu</label>
                            <input type="text" class="form-control" name="chatlieu" placeholder="VD: Cotton 100%, Polyester...">
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="noibat" value="1" id="featuredCheck">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Thêm một size mặc định khi trang load
            addSizeItem();
        ...
        function removeSizeItem(button) {
            ...
            if (sizeList.children.length === 1) { // Chỉ còn thông báo noSizes
